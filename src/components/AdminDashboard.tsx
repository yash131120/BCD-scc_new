          ...
          {activeTab === 'dashboard' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="mt-4 flex items-center gap-2">
                    ...
                    <span className="text-sm text-blue-600">{analytics.publishedCards} published</span>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="mt-4 flex items-center gap-2">
                    ...
                    <span className="text-sm text-purple-600">Engagement metrics</span>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="mt-4 flex items-center gap-2">
                    ...
                    <span className="text-sm text-orange-600">Last 30 days</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Recent Cards</h3>
                  <div className="space-y-3">
                    {cards.slice(0, 5).map((card) => (
                      <div key={card.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-500">{card.profiles?.email}</p>
                        </div>
